/*
  ...
  en travaux .. priËre de porter le casque
  ...
  ouups, j'avais flinguÈ les modifs depuis la v2.3.8b
...
convert_to_ascii(char *dest, const char *_src, int dest_sz)
{
  ...
  static const struct {
    ...
    int num;
	     ...
	     {"euro;", "§", 8364},   // il faut iso8859-15 pour que Áa fasse le bon char
	     {"OElig;" , "OE", 140},
	     {"oelig;" , "oe", 156},
             {"ldots", "...", 133},
             {"hellip", "...", 133},
...
/* un printf pas trËs fin, mais avec allocation dynamique..
...
/* enleve les espaces au dÈbut et ‡ la fin */
void
...
str_to_time_t(const char *s, time_t *tt) {
  ...
  /* test format ISO 8601 http://www.w3.org/TR/NOTE-datetime -- 6 possiblitÈs
      YYYY (eg 1997)
      YYYY-MM (eg 1997-07)
...
/* rend une url prÈsentable, et lui degage la nuque si nÈcessaire */
