...
create_main_win (void)
{
  ...
  GtkWidget *pixmap4;
  GtkWidget *vbox375;
  GtkWidget *checkbutton_board_enable_hfr_pictures;
  GtkWidget *checkbutton_board_auto_dl_pictures;
  GtkWidget *frame6;
  ...
  GtkWidget *frame38;
  GtkWidget *vbox376;
  GtkWidget *checkbutton_palmipede_override_wmanager;
  GtkWidget *frame8;
  ...
  glade_menuitem = gtk_menu_item_new_with_label ("linuxfr.org (templeet/no anonymous)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("woof.lu (dacode/anonymous with ip in ua)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("mandrakefr.org (dacode)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("lordoric.free.fr (anonymous only)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("didbaba.tuxfamily.org (templeet)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("quadaemon.free.fr (sed board/anonymous only)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("dalentbouchot (anonymous only)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("old.glandium (anonymous only)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("manticore");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("daique (phplop)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  ...
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("houpla (phplop/board only)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("nofrag (board only, with authentification)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  glade_menuitem = gtk_menu_item_new_with_label ("nofrag (board only, without authentification)");
  gtk_widget_show (glade_menuitem);
  gtk_menu_append (GTK_MENU (optionmenu_site_predefined_menu), glade_menuitem);
  ...
  gtk_object_set_data_full (GTK_OBJECT (main_win), "hbox168", hbox168,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox168);
  gtk_box_pack_start (GTK_BOX (vbox7), hbox168, FALSE, FALSE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox168), checkbutton_trolldetector, FALSE, FALSE, 0);

  frame37 = gtk_frame_new ("Handling of hfr pictures ( [:totoz] )");
  gtk_widget_ref (frame37);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "frame37", frame37,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame37);
  gtk_box_pack_start (GTK_BOX (vbox7), frame37, FALSE, FALSE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame37), 5);

  hbox169 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox169);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "hbox169", hbox169,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox169);
  gtk_container_add (GTK_CONTAINER (frame37), hbox169);

  pixmap4 = create_pixmap (main_win, "totoz.xpm");
  gtk_widget_ref (pixmap4);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "pixmap4", pixmap4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (pixmap4);
  gtk_box_pack_start (GTK_BOX (hbox169), pixmap4, FALSE, FALSE, 0);
  gtk_misc_set_padding (GTK_MISC (pixmap4), 8, 0);

  vbox375 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox375);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "vbox375", vbox375,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox375);
  gtk_box_pack_start (GTK_BOX (hbox169), vbox375, FALSE, FALSE, 19);

  checkbutton_board_enable_hfr_pictures = gtk_check_button_new_with_label ("Enable this experimental feature");
  gtk_widget_ref (checkbutton_board_enable_hfr_pictures);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "checkbutton_board_enable_hfr_pictures", checkbutton_board_enable_hfr_pictures,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton_board_enable_hfr_pictures);
  gtk_box_pack_start (GTK_BOX (vbox375), checkbutton_board_enable_hfr_pictures, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, checkbutton_board_enable_hfr_pictures, "if you enable it, you will need the wmcoincoin_player to be available. Each occurence of something like [:totoz] in the messages will be linked to a picture found in forums.hardware.fr/images/perso (downloaded with the shell script wmcc-totoz-get into ~/.wmcoincoin/totoz)", NULL);

  checkbutton_board_auto_dl_pictures = gtk_check_button_new_with_label ("Automatically download [:totoz] pictures (may be dangerous!)");
  gtk_widget_ref (checkbutton_board_auto_dl_pictures);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "checkbutton_board_auto_dl_pictures", checkbutton_board_auto_dl_pictures,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton_board_auto_dl_pictures);
  gtk_box_pack_start (GTK_BOX (vbox375), checkbutton_board_auto_dl_pictures, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, checkbutton_board_auto_dl_pictures, "be carefull with this option, a shell script will be executed automatically for each picture detected. If there is a bug in this part, it could turn into a security threat", NULL);
  ...
  gtk_widget_set_usize (label24, 700, -2);
  ...
  frame38 = gtk_frame_new ("Global settings");
  gtk_widget_ref (frame38);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "frame38", frame38,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame38);
  gtk_box_pack_start (GTK_BOX (vbox11), frame38, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame38), 5);

  vbox376 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox376);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "vbox376", vbox376,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox376);
  gtk_container_add (GTK_CONTAINER (frame38), vbox376);

  checkbutton_palmipede_override_wmanager = gtk_check_button_new_with_label ("Palmipede overrides the windowmanager");
  gtk_widget_ref (checkbutton_palmipede_override_wmanager);
  gtk_object_set_data_full (GTK_OBJECT (main_win), "checkbutton_palmipede_override_wmanager", checkbutton_palmipede_override_wmanager,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton_palmipede_override_wmanager);
  gtk_box_pack_start (GTK_BOX (vbox376), checkbutton_palmipede_override_wmanager, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, checkbutton_palmipede_override_wmanager, "If set, the palmipede will handle the keyboard focus himself. If not set, the windowmanager will handle the window... but it does not work very well :-/", NULL);
  ...
  gtk_box_pack_start (GTK_BOX (vbox376), frame8, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox376), frame15, TRUE, TRUE, 0);
  ...
  gtk_tooltips_set_tip (tooltips, entry_default_ua, "yes, you can enter whatever stupid string you want, just try, don't be shy. Note that this is the DEFAULT useragent, if you just want to change your CURRENT useragent, press the tab key in the palmipede and edit it", NULL);
  ...
  table28 = gtk_table_new (2, 3, FALSE);
  ...
  gtk_table_attach (GTK_TABLE (table28), checkbutton_show_seconds, 2, 3, 0, 1,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table28), checkbutton_show_troll_score, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table28), checkbutton_show_fortune, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table28), checkbutton_show_tags, 2, 3, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table28), optionmenu_nick_mode, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table28), label172, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_widget_set_usize (label64, 685, -2);
  ...
  gtk_signal_connect (GTK_OBJECT (checkbutton_trolldetector), "toggled",
                      GTK_SIGNAL_FUNC (on_checkbutton_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (checkbutton_board_enable_hfr_pictures), "toggled",
                      GTK_SIGNAL_FUNC (on_checkbutton_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (checkbutton_board_auto_dl_pictures), "toggled",
                      GTK_SIGNAL_FUNC (on_checkbutton_toggled),
                      NULL);
  ...
  gtk_signal_connect (GTK_OBJECT (text_post_cmd2), "changed",
                      GTK_SIGNAL_FUNC (on_editable_changed),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (checkbutton_palmipede_override_wmanager), "toggled",
                      GTK_SIGNAL_FUNC (on_checkbutton_toggled),
                      NULL);
